...

{
    ...
    "category": "Method",
    "text": "julienne(T, array, code)\n\nSlice an array and create Parts of type T. T should be one of Arrays, Swaps, or Views. See the Parts package for more information. The code should a tuple of length ndims(array), where : indicates an axis parallel to slices and * indices an axis perpendicular to slices.\n\njulia> using JuliennedArrays, Base.Test\n\njulia> code = (*, :);\n\njulia> array = [5 6 4; 1 3 2; 7 9 8]\n3×3 Array{Int64,2}:\n 5  6  4\n 1  3  2\n 7  9  8\n\njulia> arrays = @inferred julienne(Views, array, (*, :));\n\njulia> @inferred map(sum, arrays)\n3-element Array{Int64,1}:\n 15\n  6\n 24\n\n\n\n"
},
